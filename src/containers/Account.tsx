...
function Account() {
  ...
  const onForgotPw = () => {
    if (username)
      Alert.alert('Xác nhận', `Reset mật khẩu tài khoản ${username}`, [
        {
          text: 'OK',
          onPress: () => {
            auth()
              ...
              .then(() => {
                Alert.alert(
                  ...
                  `Vui lòng kiểm tra email '${username}' để đặt lại mật khẩu`,
                  [{text: 'OK', onPress: () => console.log('OK Pressed')}],
                );
              })
              .catch((er: any) => {
                console.log('chh_log ---> er', er);
                Alert.alert('Reset mật khẩu thất bại', er?.message, [
                  {text: 'OK', onPress: () => console.log('OK Pressed')},
                ]);
              });
          },
      ...
      Alert.alert('Lỗi', `Vui lòng nhập thông tin tài khoản`, [
        {
          text: 'OK',
          onPress: () => {},
        },
      ...
      <ScrollView style={stylesSheet.scrollView}>
        <View style={stylesSheet.container}>
          ...
          <>
            ...
            <View style={stylesSheet.wrapForgotPw}>
              <TouchableOpacity style={stylesSheet.button} onPress={onForgotPw}>
                <Text style={stylesSheet.textSignup}>{t('Quên mật khẩu')}</Text>
              </TouchableOpacity>
            </View>
          </>
